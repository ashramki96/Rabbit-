...
Revision ID: 007e50e63e2c
Revises: 
Create Date: 2023-01-08 16:21:40.627340
...
def upgrade():
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('post_id', sa.Integer(), nullable=False),
    sa.Column('like_status', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['post_id'], ['posts.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    if environment == "production":
        ...
        op.execute(f'alter table subreddits_users set schema {SCHEMA}')
        op.execute(f'alter table comments set schema {SCHEMA}')
        op.execute(f'alter table likes set schema {SCHEMA}')
        op.execute(f'alter table commentlikes set schema {SCHEMA}')
